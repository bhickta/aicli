"""Implementation of ImageVisionProvider using vLLM via OpenAI-compatible API."""
...
class VLLMProvider(ImageVisionProvider):
    """vLLM provider for image vision and text completion."""
    ...
    def describe_image(
        ...
        """Send a base64-encoded image + prompt to vLLM, return text."""
        ...
        return self._post_with_retry(
            "/v1/chat/completions", payload, max_retries, retry_backoff_base
        )
