...
export const videoWorkflowDefinitions: WorkflowDefinition[] = [
  {
    ...
    fields: [
      ...
      { type: "number", id: "transcript_workers", label: "Transcription workers (0 = auto)", min: 0, max: 8, default: 0 },
      { type: "number", id: "compression_workers", label: "Compression workers (0 = auto)", min: 0, max: 12, default: 0 },
